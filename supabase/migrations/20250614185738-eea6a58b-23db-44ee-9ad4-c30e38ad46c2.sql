...
-- Completely fix the ambiguous column reference issue in get_or_create_meeting function
...
BEGIN
  -- First try to get existing meeting using table alias to avoid ambiguity
  SELECT 
    meetings.id,
    meetings.meeting_id,
    meetings.title,

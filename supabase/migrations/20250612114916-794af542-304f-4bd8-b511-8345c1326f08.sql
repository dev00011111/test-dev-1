...
-- Fix the ambiguous column reference in get_or_create_meeting function
...
BEGIN
  ...
  ON CONFLICT (meeting_id) DO UPDATE SET
    updated_at = NOW()
  RETURNING id, meeting_id, title, host_id, status, started_at, ended_at, created_at, updated_at, minimum_attendance_minutes
  INTO meeting_record;
